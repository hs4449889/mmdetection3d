...
def main():
    ...
    wandb.init(project="resherch",group="hv_pointpillars_secfpn_6x8_160e_kitti-3d-3class_use_pth", sync_tensorboard=True)
    ...
    # TODO この部分はtest.pyに準じていない(checkpointからmeta情報を取得していない)
