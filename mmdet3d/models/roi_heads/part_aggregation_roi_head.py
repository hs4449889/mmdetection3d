...
class PartAggregationROIHead(Base3DRoIHead):
    ...
    def simple_test(
        self, feats_dict, voxels_dict, img_metas, proposal_list, **kwargs
    ):
    ...
    def _bbox_forward_train(
        self, seg_feats, part_feats, voxels_dict, sampling_results
    ):
        ...
        bbox_results = self._bbox_forward(
            seg_feats, part_feats, voxels_dict, rois
        )
    ...
    def _bbox_forward(self, seg_feats, part_feats, voxels_dict, rois):
        ...
        cls_score, bbox_pred = self.bbox_head(
            pooled_seg_feats, pooled_part_feats
        )
    ...
    def _semantic_forward_train(
        self, x, voxels_dict, gt_bboxes_3d, gt_labels_3d
    ):
        """Train semantic head.
        ...
        loss_semantic = self.semantic_head.loss(
