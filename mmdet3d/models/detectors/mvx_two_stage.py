...
class MVXTwoStageDetector(Base3DDetector):
    ...
    def with_fusion(self):
        ...
        return (
            hasattr(self, "pts_fusion_layer") and self.fusion_layer is not None
        )
    ...
    def with_voxel_encoder(self):
        ...
        return (
            hasattr(self, "voxel_encoder") and self.voxel_encoder is not None
        )
    ...
    def with_middle_encoder(self):
        ...
        return (
            hasattr(self, "middle_encoder") and self.middle_encoder is not None
        )
    ...
    def simple_test_img(self, x, img_metas, proposals=None, rescale=False):
        ...
        if proposals is None:
            proposal_list = self.simple_test_rpn(
                x, img_metas, self.test_cfg.img_rpn
            )
        else:
            proposal_list = proposals
    ...
    def extract_feats(self, points, img_metas, imgs=None):
        ...
        img_feats, pts_feats = multi_apply(
    ...
    def show_results(self, data, result, out_dir):
        ...
        for batch_id in range(len(result)):
            ...
            if (box_mode_3d == Box3DMode.CAM) or (
