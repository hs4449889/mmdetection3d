...
def sample_valid_seeds(mask, num_sampled_seed=1024):
    ...
    sample_inds = mask.new_zeros(
        (batch_size, num_sampled_seed), dtype=torch.int64
    )
...
class ImVoteNet(Base3DDetector):
    ...
    def with_img_bbox(self):
        ...
        return (
            hasattr(self, "img_roi_head") and self.img_roi_head.with_bbox
        ) or (
    ...
    def with_pts_bbox(self):
        ...
        return (
            hasattr(self, "pts_bbox_head") and self.pts_bbox_head is not None
        )
    ...
    @torch.no_grad()
    def extract_bboxes_2d(
        self, img, img_metas, train=True, bboxes_2d=None, **kwargs
    ):
        ...
        **kwargs,
        ...
        if points is None:
            ...
            img_features, masks = self.fusion_layer(
                img, bboxes_2d, seeds_3d, img_metas
            )
            ...
            inds_img = inds.view(batch_size, 1, -1).expand(
                -1, img_feat_size, -1
            )
            ...
            inds_seed_feats = inds.view(batch_size, 1, -1).expand(
                -1, pts_feat_size, -1
            )
            ...
            losses_pts = self.pts_bbox_head_pts.loss(
                bbox_preds_pts, *loss_inputs, gt_bboxes_ignore=gt_bboxes_ignore
            )
            losses_img = self.pts_bbox_head_img.loss(
                bbox_preds_img, *loss_inputs, gt_bboxes_ignore=gt_bboxes_ignore
            )
    ...
    def forward_test(
        self, points=None, img_metas=None, img=None, bboxes_2d=None, **kwargs
    ):
        ...
        if points is None:
            ...
            for var, name in [(points, "points"), (img_metas, "img_metas")]:
                if not isinstance(var, list):
                    raise TypeError(
                        "{} must be a list, but got {}".format(name, type(var))
                    )
            ...
            if num_augs == 1:
                ...
                return self.aug_test(
                    points, img_metas, img, bboxes_2d, **kwargs
                )

    def simple_test_img_only(
    ...
    def simple_test(
        ...
        **kwargs,
        ...
        bbox_preds = self.pts_bbox_head_joint(
            feat_dict, self.test_cfg.pts.sample_mod
        )
    ...
    def aug_test(
        ...
        **kwargs,
        ...
        for x, pts_cat, img_meta, bbox_2d, img in zip(
            ...
            img_features, masks = self.fusion_layer(
                img, bbox_2d, seeds_3d, img_metas
            )
