...
class VoteHead(BaseModule):
    ...
    def get_targets(
        ...
        for index in range(len(gt_labels_3d)):
            ...
            center_targets[index] = F.pad(
                center_targets[index], (0, 0, 0, pad_num)
            )
    ...
    def get_targets_single(
        ...
        if self.bbox_coder.with_rot:
            ...
            vote_target_masks = points.new_zeros(
        ...
        objectness_targets[
            euclidean_distance1 < self.train_cfg["pos_distance_thr"]
        ] = 1
        ...
        objectness_masks[
            euclidean_distance1 > self.train_cfg["neg_distance_thr"]
        ] = 1.0
