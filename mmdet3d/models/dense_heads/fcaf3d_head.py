...
class FCAF3DHead(BaseModule):
    ...
    def forward_test(self, x, input_metas):
        ...
        return self._get_bboxes(
            center_preds, bbox_preds, cls_preds, points, input_metas
        )
    ...
    def _get_bboxes_single(
        self, center_preds, bbox_preds, cls_preds, points, input_meta
    ):
    ...
    def _get_bboxes(
        self, center_preds, bbox_preds, cls_preds, points, input_metas
    ):
    ...
    def _get_face_distances(points, boxes):
        ...
        shift = rotation_3d_in_axis(shift, -boxes[0, :, 6], axis=2).permute(
            1, 0, 2
        )
    ...
    def _get_targets(self, points, gt_bboxes, gt_labels):
        ...
        best_level = torch.where(
            all_upper_limit_mask, n_levels - 1, lower_index
        )
