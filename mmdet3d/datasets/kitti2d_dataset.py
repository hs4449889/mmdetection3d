...
class Kitti2DDataset(CustomDataset):
    ...
    def load_annotations(self, ann_file):
        ...
        self.cat2label = {
            cat_name: i for i, cat_name in enumerate(self.CLASSES)
        }
    ...
    def get_ann_info(self, index):
        ...
        anns_results = dict(
            bboxes=gt_bboxes.astype(np.float32), labels=gt_labels,
        )
        return anns_results
    ...
    def reformat_bbox(self, outputs, out=None):
        ...
        result_files = bbox2result_kitti2d(
            outputs, self.CLASSES, sample_idx, out
        )
        return result_files
