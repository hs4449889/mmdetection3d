...
class Custom3DSegDataset(Dataset):
    ...
    def __init__(
        ...
        self.ignore_index = (
            len(self.CLASSES) if ignore_index is None else ignore_index
        )
    ...
    def get_classes_and_palette(self, classes=None, palette=None):
        ...
        if classes is None:
            ...
            self.label2cat = {
                i: cat_name for i, cat_name in enumerate(self.CLASSES)
            }
        ...
        if self.CLASSES:
            ...
            self.label2cat = {
                i: cat_name for i, cat_name in enumerate(class_names)
            }
    ...
    def format_results(
        self, outputs, pklfile_prefix=None, submission_prefix=None
    ):
