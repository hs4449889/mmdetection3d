...
def kitti_eval(
    ...
    for j, curcls in enumerate(current_classes):
        ...
        for i in range(min_overlaps.shape[0]):
            ...
            for idx in range(3):
                ...
                if mAP11_3d is not None:
                    ret_dict[f"{prefix}_3D_AP11_{postfix}"] = mAP11_3d[
                        j, idx, i
                    ]
                if mAP11_bev is not None:
                    ret_dict[f"{prefix}_BEV_AP11_{postfix}"] = mAP11_bev[
                        j, idx, i
                    ]
                if mAP11_bbox is not None:
                    ret_dict[f"{prefix}_2D_AP11_{postfix}"] = mAP11_bbox[
                        j, idx, i
                    ]
    ...
    if len(current_classes) > 1:
        ...
        for idx in range(3):
            ...
            if mAP11_bev is not None:
                ret_dict[f"KITTI/Overall_BEV_AP11_{postfix}"] = mAP11_bev[
                    idx, 0
                ]
            if mAP11_bbox is not None:
                ret_dict[f"KITTI/Overall_2D_AP11_{postfix}"] = mAP11_bbox[
                    idx, 0
                ]
    ...
    for j, curcls in enumerate(current_classes):
        ...
        for i in range(min_overlaps.shape[0]):
            ...
            for idx in range(3):
                ...
                prefix = f"KITTI/{curcls_name}"
                if mAP40_3d is not None:
                    ret_dict[f"{prefix}_3D_AP40_{postfix}"] = mAP40_3d[
                        j, idx, i
                    ]
                if mAP40_bev is not None:
                    ret_dict[f"{prefix}_BEV_AP40_{postfix}"] = mAP40_bev[
                        j, idx, i
                    ]
                if mAP40_bbox is not None:
                    ret_dict[f"{prefix}_2D_AP40_{postfix}"] = mAP40_bbox[
                        j, idx, i
                    ]
    ...
    if len(current_classes) > 1:
        ...
        for idx in range(3):
            ...
            if mAP40_bev is not None:
                ret_dict[f"KITTI/Overall_BEV_AP40_{postfix}"] = mAP40_bev[
                    idx, 0
                ]
            if mAP40_bbox is not None:
                ret_dict[f"KITTI/Overall_2D_AP40_{postfix}"] = mAP40_bbox[
                    idx, 0
                ]
