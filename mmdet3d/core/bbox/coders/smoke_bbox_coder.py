...
class SMOKECoder(BaseBBoxCoder):
    ...
    def decode(
        self, reg, points, labels, cam2imgs, trans_mats, locations=None
    ):
    ...
    def _decode_location(
        self, points, centers2d_offsets, depths, cam2imgs, trans_mats
    ):
        ...
        centers2d_extend = torch.cat(
            (centers2d, centers2d.new_ones(N, 1)), dim=1
        )
