...
def _generate_sunrgbd_dataset_config():
    ...
    pipelines = [
        ...
        dict(
            type="RandomFlip3D", sync_2d=False, flip_ratio_bev_horizontal=0.5,
        ),
        dict(
...
def test_getitem():
    ...
    pcd_rotation_expected = np.array(
        [
            [0.99889565, 0.04698427, 0.0],
            [-0.04698427, 0.99889565, 0.0],
            [0.0, 0.0, 1.0],
        ]
    )
    ...
    expected_rt_mat = np.array(
        [
            [0.97959, 0.012593, -0.20061],
            [0.012593, 0.99223, 0.12377],
            [0.20061, -0.12377, 0.97182],
        ]
    )
    expected_k_mat = np.array(
        [[529.5, 0.0, 0.0], [0.0, 529.5, 0.0], [365.0, 265.0, 1.0]]
    )
    rt_mat = np.array(
        [[1, 0, 0], [0, 0, -1], [0, 1, 0]]
