...
from mmdet3d.core.evaluation.kitti_utils.eval import (
    do_eval,
    eval_class,
    kitti_eval,
)
...
def test_kitti_eval():
    ...
    assert np.isclose(
        ret_dict["KITTI/Overall_2D_AP11_moderate"], 9.090909090909092
    )
    assert np.isclose(
        ret_dict["KITTI/Overall_2D_AP11_hard"], 9.090909090909092
    )
    assert np.isclose(
        ret_dict["KITTI/Overall_2D_AP40_moderate"], 0.8333333333333334
    )
    assert np.isclose(
        ret_dict["KITTI/Overall_2D_AP40_hard"], 0.8333333333333334
    )
